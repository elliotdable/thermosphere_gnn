...
NET_TYPE="gat" # "gcn" or "tgn" or "gat"
...
echo "PCA flag set to: $PCA_FLAG"s
...
apptainer exec --nv \
  ...
  bash -c "
    ...
    python /mnt/fpi_gnn_training/src/${NET_TYPE}/run_main.py \
      ...
      --num_neighbours_l1 $NUM_NEIGHBOURS_L1 \
      --num_neighbours_l2 $NUM_NEIGHBOURS_L2 \
